...
colnames(report)<-c("campaign_id",	"Название кампании",	"Ключевые слова",	"Расход",	"Сессии",	"Показы",	"Клики",	"CPC",	"Средняя позиция клика",	"Средняя позиция показа",	"CTR",	"Достижения целей",	"Доход",	"CPA",	"ROI")
